...
| # | 决策点 | 选定方案 | 理由 |
|---|--------|----------|------|
| 1 | **后端技术栈** | Node.js + Fastify | TypeScript 全栈，类型共享 |
| 2 | **数据库** | PostgreSQL | 关系模型 + 原框架架构文档已按 PG 设计 |
| 3 | **ORM** | Prisma | Schema 迁移 + 类型安全 + 支持局部调整 |
| 4 | **状态管理** | Zustand | 轻量、学习曲线低 |
| 5 | **测试框架** | Vitest | Vite 生态一致 |
